...
namespace Synapse.Ldap.Tests
{
    ...
    public class UserTests
    {
        ...
        public void MoveUserToOrganizationUnitSucceeds()
        {
            ...
            DirectoryServices.CreateUserEx(ldapPath, userName, userPassword);
        ...
        public void CreateUserReturnGuid()
        {
            ...
            // Act
            // Assert
            Assert.DoesNotThrow(() => DirectoryServices.CreateUserEx(ldapPath, userName, userPassword));
        }
...
//        {
//            // Arrange 
//            string domain = DirectoryServices.GetDomainDistinguishedName();
//            // Act
