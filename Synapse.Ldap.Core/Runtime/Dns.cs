...
namespace Synapse.Ldap.Core
{
    public partial class DirectoryServices
    {
        ...
        public static void DeleteARecord(string aRecordName, string dnsServerName = ".", string dnsZone = "", bool isDryRun = false)
        {
            ...
            {
                throw new LdapException( "A record name is not specified.", LdapStatusType.MissingInput );
            }

            if ( string.IsNullOrWhiteSpace( dnsServerName ) )
            {
                throw new LdapException( "DNS server name is not specified.", LdapStatusType.MissingInput );
            }
        ...
        public static void DeletePtrRecord(string ipAddress, string dnsServerName = ".", string dnsZone = "", bool isDryRun = false)
        {
            ...
            {
                throw new LdapException( "IP address is not specified.", LdapStatusType.MissingInput );
            }
