...
namespace Synapse.ActiveDirectory.Tests
{
    ...
    public class UserTests
    {
        ...
        public void SetUserPassword_Without_Username_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.SetUserPassword(username, newPassword));
        ...
        public void SetUserPassword_Non_Existent_User_Dry_Run_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.SetUserPassword(username, newPassword, true));
        ...
        public void CreateUser_Without_Username_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.CreateUser(username, ldapRoot, userPassword, givenName, surname, description));
        ...
        public void CreateUser_Without_Password_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.CreateUser(username, ldapPath, userPassword, givenName, surname, description));
        ...
        public void DisableUserAccount_Non_Existent_User_Dry_Run_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.DisableUserAccount(username, true));
        ...
        public void EnableUserAccount_Without_Username_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.EnableUserAccount(username));
        ...
        public void EnableUserAccount_Non_Existent_User_Dry_Run_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.EnableUserAccount(username, true));
        ...
        public void ExpireUserPassword_Without_Username_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.ExpireUserPassword(username));
        ...
        public void ExpireUserPassword_Non_Existent_User_Dry_Run_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.ExpireUserPassword(username, true));
        ...
        public void UnlockUserAccount_Without_Username_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.UnlockUserAccount(username));
        ...
        public void UnlockUserAccount_Non_Existent_User_Dry_Run_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.UnlockUserAccount(username, true));
        ...
        public void UpdateUserAttribute_Without_Username_Throw_Exception()
        {
            ...
            // Act
            Exception ex = Assert.Throws<AdException>(() => DirectoryServices.UpdateUserAttribute(username, attribute, value));
